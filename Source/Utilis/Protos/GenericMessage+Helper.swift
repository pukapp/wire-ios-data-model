...
extension GenericMessage {
    public var messageData: MessageCapable? {
        ...
        case .buttonActionConfirmation(let data):
            return data
        case .forbid(let data):
            return data
        case .mediasoup(let data):
            return data
        }
    }
...
public extension NewOtrMessage {
    init(withSender sender: UserClient, nativePush: Bool, recipients: [UserEntry], blob: Data? = nil, unblock: Bool = false) {
