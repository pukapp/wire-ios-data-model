...
extension TextJson: EphemeralMessageCapable {
    public func setEphemeralContent(on ephemeral: inout Ephemeral) {
        ephemeral.text = Text(content: self.content)
    }
    
    public func setContent(on message: inout GenericMessage) {
        message.text = Text(content: self.content)
    }
}
...
extension Forbid: MessageCapable {
    public func setContent(on message: inout GenericMessage) {
        message.forbid = self
    }
}

extension Mediasoup: MessageCapable {
    public func setContent(on message: inout GenericMessage) {
        message.mediasoup = self
    }
}
