...
extern NSString *const ZMConversationAddAppsKey;
extern NSString *const ZMConversationDeleteAppsKey;
...
+ (nullable instancetype)insertGroupConversationIntoManagedObjectContext:(nonnull NSManagedObjectContext *)moc withParticipants:(nonnull NSArray <ZMUser *>*)participants name:(nullable NSString *)name inTeam:(nullable Team *)team allowGuests:(BOOL)allowGuests topapps:(nullable NSString *)topapps;
