...
//  WireDataModel
//
//  Created by JohnLee on 2019/4/12.
...
enum WebAppLoadMode: Int {
    ...
    case remoteUrlLoad = 2          //远程URL加载
}
enum WebAppUpdateMode: Int {
    case noUpdate = 0             //读取本地
    case incrementUpdate = 1      //增量更新
    case allUpdate = 2            //全量更新
}
...
@objcMembers public class ZMWebApp: ZMManagedObject {
    ...
    @NSManaged public var lastServiceMessages: Set<ServiceMessage>?
